...
class ViemAdapter extends EvmAdapter {
    ...
    publicClient, contractCall, targetChain, resolvedAddress) {
    ...
    async prepare(params, ctx) {
        ...
        return this.prepareStateChangingFunction(walletClient, publicClient, contractCallParams, targetChain, resolvedContext.address);
    }
    /**
